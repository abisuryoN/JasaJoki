...
export default function TermsPage() {
    return (
        <div className="min-h-screen bg-[#020617] pt-32 pb-20 px-4">
            <SEO
                title="Syarat & Ketentuan DualCode"
                description="Syarat dan ketentuan penggunaan layanan jasa IT DualCode meliputi scope pengerjaan, pembayaran, kebijakan revisi, dan tanggung jawab."
                keywords="syarat ketentuan, terms of service, aturan jasa coding, kebijakan dualcode"
                canonicalUrl="/terms"
            />
